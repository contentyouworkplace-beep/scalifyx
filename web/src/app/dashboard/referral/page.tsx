...
export default function SharePage() {
  ...
  const shareLink = 'https://scalifyapp.com';
  const shareMessage = `Hey! Check out Scalify — build a professional website with SEO in 60 seconds\n\n${shareLink}`;

  const handleShare = () => {
    if (navigator.share) {
      navigator.share({ title: 'Scalify', text: shareMessage, url: shareLink });
    } else {
  ...
  return (
    <div className="max-w-lg mx-auto md:max-w-2xl">
      <h1 className="text-2xl font-extrabold mb-4">Share Scalify</h1>
      ...
      <div className="space-y-3 mb-6">
        {[
          { step: '1', title: 'Share the Link', desc: 'Send Scalify link to friends via WhatsApp or any channel' },
