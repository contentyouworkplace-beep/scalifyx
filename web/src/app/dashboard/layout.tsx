...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-bg">
      ...
      {/* Sticky WhatsApp support FAB — bottom right */}
      <a
        href="https://wa.me/916353583148?text=Hi%2C%20I%20need%20help%20with%20my%20Scalify%20account"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-24 md:bottom-6 right-4 md:right-6 z-50 flex items-center gap-2 bg-[#25D366] hover:bg-[#20b858] text-white px-4 py-3 rounded-full shadow-lg shadow-green-500/30 transition-all hover:scale-105 active:scale-95"
