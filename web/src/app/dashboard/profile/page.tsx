...
const MENU_ITEMS = [
  ...
  { Icon: ShareIcon, label: 'Share Scalify', href: '/dashboard/referral', action: null },
  ...
  return (
    <div className="max-w-lg mx-auto md:max-w-2xl">
      ...
      <div className="rounded-2xl bg-card border border-border p-6 text-center mb-4">
        ...
        <div className="text-lg md:text-xl font-bold">{user?.name || 'Scalify User'}</div>
      ...
      <div className="text-center text-xs text-zinc-600 mt-4 mb-6">Scalify v1.0.0</div>
    </div>
  );
}
