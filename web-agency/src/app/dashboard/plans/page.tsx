...
import { GlobeIcon, DiamondIcon, SearchIcon, SparklesIcon } from '../../../components/Icons';
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-zinc-400">Choose the perfect service package for your project needs. All packages include dedicated support.</p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="mb-4 py-4 border-t border-b border-border">
                ...
                <p className="text-xs text-zinc-500">Timeline: {service.timeline}</p>
              </div>
          ...
          {[
            {
              ...
              a: 'Absolutely! All our packages are customizable based on your specific needs. Submit an inquiry and we\'ll discuss your requirements during the discovery call.',
            },
            {
              q: 'What\'s the payment structure?',
              a: 'Project-based services require 50% upfront and 50% upon delivery. Monthly services (like SEO) are billed monthly with a minimum 3-month commitment.',
            },
            {
              q: 'Do you offer support after delivery?',
              a: 'Yes! All packages include 30 days of post-launch support. Extended support and maintenance plans are available.',
            },
            {
              q: 'What if I need revisions?',
              a: 'Revision rounds are included in each package. Additional revisions beyond the included rounds are available at ₹5,000 per round.',
            },
          ].map((faq, idx) => (
